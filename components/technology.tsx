  ...
  return (
    <section id="technology" className="section relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-50">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(0deg,_transparent_0%,_rgba(0,255,255,0.05)_25%,_transparent_50%,_rgba(0,255,255,0.05)_75%,_transparent_100%)] animate-server-lights" style={{ animationDelay: '1s' }} />
